...
<div class="min-h-screen bg-gray-950 text-gray-100 flex items-center justify-center px-4">
	<div class="w-full max-w-sm">
		...
		<div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
			...
			<a
				href="/auth/github"
				class="flex items-center justify-center gap-3 w-full bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-3 rounded-xl font-medium transition"
			>
			...
			<div class="relative">
				...
				<div class="relative flex justify-center text-xs"><span class="px-3 bg-gray-900 text-gray-600">or</span></div>
			</div>
